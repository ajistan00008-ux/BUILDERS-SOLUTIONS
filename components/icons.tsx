...
export const Globe = (p: P) => (<svg {...base(p)}><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3a15 15 0 0 1 0 18M12 3a15 15 0 0 0 0 18" /></svg>);
export const Quote = (p: P) => (<svg {...base({ ...p, fill: 'currentColor', stroke: 'none' })}><path d="M7 7h4v6c0 2.2-1.8 4-4 4v-2c1 0 2-.9 2-2H7V7zm8 0h4v6c0 2.2-1.8 4-4 4v-2c1 0 2-.9 2-2h-2V7z" /></svg>);
...
export const Chat = (p: P) => (<svg {...base(p)}><path d="M21 11.5a8.4 8.4 0 0 1-9 8.4 9 9 0 0 1-3.9-.8L3 21l1.9-5.1A8.4 8.4 0 0 1 12 3a8.5 8.5 0 0 1 9 8.5z" /></svg>);
